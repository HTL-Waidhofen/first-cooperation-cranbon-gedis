function moreInfo(event){
    ...
    switch(event){
        case "deiac":
            ...
            break;
        case "forstner":
            info="<p><strong>Name:</strong> Kevin Forstner</p><p><strong>Skills:</strong> ...</p><p><strong>Aufgabe:</strong> </p> <p><strong>Mehr Info:</strong> <a href='forstner.html' target='blank'>Kevoo</a></p>";
            break;
        case "berchti":
